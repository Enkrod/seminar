...
{
    /**
     * @var \Streit\Seminar\Controller\TypeController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Streit\Seminar\Controller\TypeController::class)
    ...
    public function listActionFetchesAllTypesFromRepositoryAndAssignsThemToView()
    {
        ...
        $typeRepository = $this->getMockBuilder(\::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $type = new \Streit\Seminar\Domain\Model\Type();
